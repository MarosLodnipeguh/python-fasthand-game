...
from main import init_new_game, player_turn, computer_turn, print_game_table  # Importuj logikę gry

from main import p2_supply, p1_hand, p1_supply, p2_hand, gamestack1, gamestack2
